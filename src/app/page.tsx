...
export default function Home() {
  return (
    <div className="min-h-screen bg-[#4c0a31] flex items-center justify-center p-6">
      <div className="flex flex-col rounded-[9px] shadow-[0px_20px_30px_-10px_#270419] overflow-hidden max-w-[563px] w-full">
        {/* Hero Image */}
        <div className="relative w-full aspect-[563/844]">
          <Image
            src="/hero-image.png"
        ...
        <div className="bg-[#c1b17d] flex flex-col items-center gap-[70px] px-10 py-10">
          ...
          <button
            ...
            className="w-[105px] h-[105px] rounded-full transition-transform hover:scale-105 active:scale-95"
          >
            <svg
              viewBox="0 0 105 105"
              fill="none"
